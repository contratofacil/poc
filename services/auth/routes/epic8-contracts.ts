...
export const TEMPLATES: ContractTemplate[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'type_nda', label: 'Type de NDA', type: 'select', options: ['Unilatéral', 'Bilatéral', 'Multilatéral'] },
      { key: 'divulgateur', label: "Partie divulgatrice (nom & type d'entité)", type: 'text' },
      { key: 'recepteur', label: "Partie réceptrice (nom & type d'entité)", type: 'text' },
      { key: 'objet', label: 'Objet / Finalité de la divulgation', type: 'text' },
      ...
      { key: 'carve_outs', label: 'Exclusions / Exceptions spécifiques (optionnel)', type: 'textarea', optional: true },
    ],
  },
];
